...
import org.example.hhhhh.model.bo.WorkshopOneGetCuttingDetailsInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetCuttingMaterialBatchInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetCuttingSpeedValueInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetForgingDataInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetForgingTempValueInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetFullCuttingDataInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetFullForgingDataInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetHoldTimeValueInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetMaterialBatchStatsInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetPressingDataInputBO;
import org.example.hhhhh.model.bo.WorkshopOneGetPressureValueInputBO;
import org.example.hhhhh.model.bo.WorkshopOneHasDataInputBO;
import org.example.hhhhh.model.bo.WorkshopOneReceiveMaterialInputBO;
import org.example.hhhhh.model.bo.WorkshopOneRecordCuttingInputBO;
import org.example.hhhhh.model.bo.WorkshopOneRecordForgingInputBO;
import org.example.hhhhh.model.bo.WorkshopOneRecordPressingInputBO;
...
public class WorkshopOneService {
  public static final String ABI = org.example.hhhhh.utils.IOUtil.readResourceAsString("abi/WorkshopOne.abi");

  public static final String BINARY = org.example.hhhhh.utils.IOUtil.readResourceAsString("bin/ecc/WorkshopOne.bin");

  public static final String SM_BINARY = org.example.hhhhh.utils.IOUtil.readResourceAsString("bin/sm/WorkshopOne.bin");
