...
const routes = [
    ...
    { path: '/login', name: 'Login', meta: { name: '登录' }, component: () => import('../views/login.vue') },
    {
        ...
        component: Home,
        children: [
            { path: '/data-annotation', name: 'Data-annotation.vue', meta: { name: '数据标注' }, component: () => import('../components/data-annotation.vue') },//新增数据标注路由
            ...
            { path: '/production', name: 'Production', meta: { name: '私有链管理' }, component: () => import('../components/private.vue') }, // 私有链管理页面
        ]
    }
]
