...
import org.example.Demo01.model.bo.Workshop2CompleteNextStepInputBO;
import org.example.Demo01.model.bo.Workshop2SetDataInputBO;
...
@NoArgsConstructor
@Data
public class Workshop2Service {
  public static final String ABI = org.example.Demo01.utils.IOUtil.readResourceAsString("abi/Workshop2.abi");

  public static final String BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/ecc/Workshop2.bin");

  public static final String SM_BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/sm/Workshop2.bin");

  @Value("${system.contract.workshop2Address}")
  ...
  public TransactionResponse completeNextStep(Workshop2CompleteNextStepInputBO input) throws Exception {
  ...
  public TransactionResponse setData(Workshop2SetDataInputBO input) throws Exception {
