...
import org.example.Demo01.model.bo.Workshop1CompleteNextStepInputBO;
import org.example.Demo01.model.bo.Workshop1SetDataInputBO;
...
@NoArgsConstructor
@Data
public class Workshop1Service {
  public static final String ABI = org.example.Demo01.utils.IOUtil.readResourceAsString("abi/Workshop1.abi");

  public static final String BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/ecc/Workshop1.bin");

  public static final String SM_BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/sm/Workshop1.bin");

  @Value("${system.contract.workshop1Address}")
  ...
  public TransactionResponse completeNextStep(Workshop1CompleteNextStepInputBO input) throws Exception {
    return this.txProcessor.sendTransactionAndGetResponse(this.address, ABI, "completeNextStep", input.toArgs());
  }
  ...
  public CallResponse rawMaterial() throws Exception {
    return this.txProcessor.sendCall(this.client.getCryptoSuite().getCryptoKeyPair().getAddress(), this.address, ABI, "rawMaterial", Arrays.asList());
  }

  public TransactionResponse setData(Workshop1SetDataInputBO input) throws Exception {
  ...
  public CallResponse currentStepIndex() throws Exception {
    return this.txProcessor.sendCall(this.client.getCryptoSuite().getCryptoKeyPair().getAddress(), this.address, ABI, "currentStepIndex", Arrays.asList());
  }
