...
import org.example.Demo01.model.bo.Workshop3CompleteNextStepInputBO;
import org.example.Demo01.model.bo.Workshop3SetDataInputBO;
...
@NoArgsConstructor
@Data
public class Workshop3Service {
  public static final String ABI = org.example.Demo01.utils.IOUtil.readResourceAsString("abi/Workshop3.abi");

  public static final String BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/ecc/Workshop3.bin");

  public static final String SM_BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/sm/Workshop3.bin");

  @Value("${system.contract.workshop3Address}")
  ...
  public TransactionResponse completeNextStep(Workshop3CompleteNextStepInputBO input) throws Exception {
  ...
  public TransactionResponse setData(Workshop3SetDataInputBO input) throws Exception {
