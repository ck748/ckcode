...
import org.example.Demo01.model.bo.Workshop5SetDataInputBO;
...
@NoArgsConstructor
@Data
public class Workshop5Service {
  public static final String ABI = org.example.Demo01.utils.IOUtil.readResourceAsString("abi/Workshop5.abi");

  public static final String BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/ecc/Workshop5.bin");

  public static final String SM_BINARY = org.example.Demo01.utils.IOUtil.readResourceAsString("bin/sm/Workshop5.bin");

  @Value("${system.contract.workshop5Address}")
  ...
  public CallResponse shipOut() throws Exception {
    return this.txProcessor.sendCall(this.client.getCryptoSuite().getCryptoKeyPair().getAddress(), this.address, ABI, "shipOut", Arrays.asList());
  }
  ...
  public TransactionResponse setData(Workshop5SetDataInputBO input) throws Exception {
