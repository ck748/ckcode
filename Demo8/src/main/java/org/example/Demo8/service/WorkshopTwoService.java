...
import org.example.Demo8.model.bo.WorkshopTwoGetCoolingRateValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetDrillingDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetEquipmentSpeedValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetFeedRateValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetFullDrillingDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetFullGearProcessingDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetFullHeatTreatmentDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetFullTurningDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetGearProcessingDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetHeatTreatmentDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetHeatingTempValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetHoldTimeValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetHoleDepthValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetRotationSpeedValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetSurfaceHardnessValueInputBO;
import org.example.Demo8.model.bo.WorkshopTwoGetTurningDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoHasDataInputBO;
import org.example.Demo8.model.bo.WorkshopTwoMarkAsScrapInputBO;
import org.example.Demo8.model.bo.WorkshopTwoMarkAsScrapWithReasonInputBO;
import org.example.Demo8.model.bo.WorkshopTwoReceiveProductsInputBO;
import org.example.Demo8.model.bo.WorkshopTwoRecordDrillingInputBO;
import org.example.Demo8.model.bo.WorkshopTwoRecordGearProcessingInputBO;
import org.example.Demo8.model.bo.WorkshopTwoRecordHeatTreatmentInputBO;
import org.example.Demo8.model.bo.WorkshopTwoRecordTurningInputBO;
...
public class WorkshopTwoService {
  public static final String ABI = org.example.Demo8.utils.IOUtil.readResourceAsString("abi/WorkshopTwo.abi");

  public static final String BINARY = org.example.Demo8.utils.IOUtil.readResourceAsString("bin/ecc/WorkshopTwo.bin");

  public static final String SM_BINARY = org.example.Demo8.utils.IOUtil.readResourceAsString("bin/sm/WorkshopTwo.bin");
